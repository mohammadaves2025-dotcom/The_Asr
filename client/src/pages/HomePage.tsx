          ...
          <aside className="lg:col-span-4">
            <div className="lg:sticky lg:top-6 space-y-5">
              ...
              <div className="border border-gray-200 p-5 rounded-xl">
                ...
                <p className="text-[13px] text-ink font-serif font-semibold leading-snug mb-2">Independent. Reader-funded. Fearless.</p>
                <p className="text-[12px] text-ink-muted font-sans leading-relaxed mb-3">
                  The Orbis Journal is an independent newsroom covering human rights, minority communities, and justice across India.
                </p>
              ...
              <div className="border border-gray-200 p-5 rounded-xl">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <a href="https://wa.me" target="_blank" rel="noopener noreferrer" title="WhatsApp"
                    className="flex items-center justify-center w-12 h-12 rounded-xl bg-green-50 hover:bg-green-500 hover:text-white text-green-600 transition-all duration-300">
