...
export default function NewsletterInline({ variant = 'default' }: Props) {
  ...
  if (variant === 'footer') {
    return (
      <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
        <div>
          <h3 className="text-xl font-serif font-bold text-brand-navy">The The Asr Dispatch</h3>
  ...
  if (variant === 'sidebar') {
    return (
      <div className="bg-brand-navy p-5">
        ...
        <h3 className="text-base font-serif font-bold text-white mb-2">The The Asr Dispatch</h3>
  ...
  return (
    <div className="bg-surface-secondary border border-gray-200 p-8 text-center">
      ...
      <h3 className="text-2xl font-serif font-bold text-ink mb-2">The The Asr Dispatch</h3>
