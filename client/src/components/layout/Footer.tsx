...
const NAV_SECTIONS = [
  {
    title: 'Formats',
    links: [
      { label: 'Just In',            href: '/format/news' },
      { label: 'Opinion & Analysis', href: '/format/opinion' },
      { label: 'Investigation',      href: '/format/investigation' },
      { label: 'Ground Report',      href: '/format/ground-report' },
      { label: 'Double Lens',        href: '/format/double-lens' },
      { label: 'Verified Report',    href: '/format/verified-report' },
      { label: 'Through the Lens',   href: '/format/photo-essay' },
      { label: 'Explainer',          href: '/format/explainer' },
      { label: 'Interview',          href: '/format/interview' },
      { label: 'Community Voice',    href: '/format/community-voices' },
    ],
  },
  {
    title: 'About',
            ...
            <div className="flex flex-wrap gap-2">
              {SOCIAL.map((s) => (
                <a
                  ...
                  title={s.label}
                  className="w-8 h-8 flex items-center justify-center border border-white/15 text-white/50 hover:text-white hover:border-white/50 rounded-md transition-all"
                >
                  {icons[s.key]}
                </a>
              ))}
