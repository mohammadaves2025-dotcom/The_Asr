    ...
    <section className="my-14">
      <div className="border-y-2 border-ink py-5 mb-8 flex flex-col sm:flex-row sm:items-end gap-3 sm:justify-between">
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-ink leading-tight italic">
      ...
      <div className="container-site py-8 animate-pulse">
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          <div className="lg:col-span-8 grid md:grid-cols-3 gap-5">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-gray-200 h-56 rounded-xl" />
            ))}
          </div>
...
export default function HomePage() {
  const { data: articlesData, isLoading } = useQuery({
    ...
    staleTime: 5 * 60 * 1000,
    refetchInterval: 2.5 * 60 * 1000, // Auto-refresh every 2.5 minutes
  });
          ...
          <aside className="lg:col-span-4 space-y-5">
            ...
            <div className="border border-gray-200 p-5 rounded-xl">
              ...
              <div className="grid grid-cols-3 gap-3">
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" title="Twitter / X" className="flex items-center justify-center w-12 h-12 rounded-xl bg-black/5 hover:bg-black hover:text-white transition-all duration-300 group">
                ...
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" title="Instagram" className="flex items-center justify-center w-12 h-12 rounded-xl bg-pink-50 hover:bg-gradient-to-br hover:from-pink-500 hover:to-rose-600 hover:text-white text-pink-600 transition-all duration-300">
                ...
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" title="YouTube" className="flex items-center justify-center w-12 h-12 rounded-xl bg-red-50 hover:bg-red-600 hover:text-white text-red-600 transition-all duration-300">
                ...
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" title="Facebook" className="flex items-center justify-center w-12 h-12 rounded-xl bg-blue-50 hover:bg-blue-600 hover:text-white text-blue-600 transition-all duration-300">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" title="LinkedIn" className="flex items-center justify-center w-12 h-12 rounded-xl bg-sky-50 hover:bg-sky-700 hover:text-white text-sky-600 transition-all duration-300">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
                <a href="https://wa.me" target="_blank" rel="noopener noreferrer" title="WhatsApp" className="flex items-center justify-center w-12 h-12 rounded-xl bg-green-50 hover:bg-green-500 hover:text-white text-green-600 transition-all duration-300">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 1.894.626 3.647 1.685 5.064L2 22l4.964-1.693A9.96 9.96 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18.125a8.08 8.08 0 01-4.11-1.155l-.294-.177-3.304 1.127 1.126-3.3-.19-.3a7.98 7.98 0 01-1.227-4.32c0-4.418 3.59-8.008 8.009-8.008 4.418 0 8.008 3.59 8.008 8.008 0 4.419-3.59 8.009-8.008 8.009zm4.418-5.983c-.24-.13-1.44-.74-1.665-.825-.22-.09-.378-.13-.538.138-.152.26-.58 1.66-.707 1.9-.126.24-.253.268-.466.167-.245-.13-.94-.346-1.786-1.104-.66-.59-1.104-1.32-1.233-1.543-.128-.226-.017-.348.095-.46.1-.1.245-.26.366-.392.12-.13.17-.22.253-.367.093-.153.045-.286-.024-.396-.066-.11-.538-1.296-.746-1.766-.196-.455-.398-.318-.538-.318-.143 0-.46-.025-.69.19-.22.218-1.046 1.022-1.046 2.49 0 1.554 1.133 3.053 1.292 3.269.158.216 2.214 3.38 5.37 4.74.753.323 1.344.51 1.8.654.757.24 1.446.207 1.992.127.607-.087 1.868-.764 2.132-1.503.262-.736.152-1.296.087-1.422z"/></svg>
                </a>
          </aside>
        </div>
      </div>
