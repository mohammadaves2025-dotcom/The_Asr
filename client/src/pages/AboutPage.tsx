...
const VALUES = [
  { icon: <Shield size={22} />, title: 'Independence', desc: 'Our reporting is guided by editorial integrity and public interest, free from political, corporate, or commercial influence' },
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-ink-secondary font-sans leading-relaxed mb-4">
              India's mainstream media has largely abandoned marginalised communities. Muslim minorities, Dalits, Adivasis, and religious minorities rarely see their stories told with accuracy, empathy, or urgency.
            </p>
