  ...
  return (
    <div className="container-site max-w-3xl py-12">
      ...
      <div className="grid sm:grid-cols-2 gap-3 mb-8">
        {TYPES.map(t => (
          <button key={t.value} onClick={() => setType(t.value)}
            className={`p-4 border-2 rounded-xl text-left transition-all ${type === t.value ? 'border-brand-navy bg-brand-navy text-white' : 'border-gray-200 hover:border-brand-navy'}`}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-surface-secondary border border-gray-200 p-4 rounded-lg text-sm text-ink-muted font-sans">
        ...
        {error && (
          <div className="flex items-center gap-2 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg text-sm font-sans">
