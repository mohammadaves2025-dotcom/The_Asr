...
import { MostRead, PopularStories, DonateCard, AboutUsCard, FollowUs } from '../components/sidebar/SidebarWidgets';
  ...
  return (
    <div className="bg-paper min-h-screen">
      ...
      <div className="container-site py-7 md:py-10">
        ...
        {/* Donate Card — mobile only, promoted to top */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10">
          ...
          <main className="lg:col-span-8 space-y-12">
            ...
            {/* About Us + Popular Stories — mobile only, promoted after Must Read */}
            ...
            {/* Follow Us — mobile only, promoted to end of main content */}
            <div className="lg:hidden">
              <FollowUs />
            </div>
          </main>

          {/* Sidebar — desktop only; mobile uses the promoted inline blocks above */}
